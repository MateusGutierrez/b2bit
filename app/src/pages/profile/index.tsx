    ...
    return (
        <div className=" h-[100vh] w-full bg-[#F1F5F9]">
            <div className="flex w-full h-[70px] items-center justify-end bg-[#FFFFFF]">
                <Button className="mr-[34px] w-[272px] h-[44px] text-[#FAFAFA] leading-[56.25px] text-[18px] font-bold rounded-[6.33px] ">Logout</Button>
            </div>
            <div className="flex justify-center">
                <Card className="w-[356px] h-[315px] mt-[95px] bg-[#FDFDFD] flex flex-col justify-between">
                    <CardHeader className="flex justify-center items-center gap-2 p-0 m-0 mt-[34px]">
                        ...
                        <img src={logo} alt="profile picture" className="h-[56px] w-[58px] rounded-[8px]" />
                    </CardHeader>
                    <CardContent className="flex flex-col gap-2">
                        ...
                        <div className="bg-[#F4F4F4] h-[44px] rounded-[8px] flex items-center pl-[20.25px]" >
                            <p className="text-[#262626] leading-3 text-xs font-normal">Christine James</p>
                        </div>
                    </CardContent>
                    <CardContent className="flex flex-col gap-2">
                        ...
                        <div className="bg-[#F4F4F4] h-[44px] rounded-[8px] flex items-center pl-[20.25px]" >
                            <p className="text-[#262626] leading-3 text-xs font-normal" >christinejames@gmail.com</p>
                        </div>
                    </CardContent>
                </Card>
            </div>
